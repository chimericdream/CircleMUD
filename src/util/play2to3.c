...
int main(int argc, char *argv[]) {
    ...
    while (!feof(ptTwoHndl)) {
        ...
        for (iIndex = 0; iIndex < 5; iIndex++) {
            stThree.char_specials_saved.apply_saving_throw[iIndex] = stTwo.specials2.apply_saving_throw[iIndex];
        }
        ...
        for (iIndex = 0; iIndex < 53; iIndex++) {
            if (iIndex > 44) {
                stThree.player_specials_saved.skills[aiSkillMappings[iIndex - 45]] = stTwo.skills[iIndex];
            }
            else {
                stThree.player_specials_saved.skills[iIndex] = stTwo.skills[iIndex];
            }
        }

        stThree.player_specials_saved.spells_to_learn = stTwo.specials2.spells_to_learn;
        ...
        stThree.player_specials_saved.freeze_level = stTwo.specials2.freeze_level;
        ...
        for (iIndex = 0; iIndex < 3; iIndex++) {
            stThree.player_specials_saved.conditions[iIndex] = stTwo.specials2.conditions[iIndex];
        }
